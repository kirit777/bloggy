...
<body>
  <nav>
    ...
    <div class="nav_menu">
      ...
      <a href="favorite.php" class="menu_item active">Favorite</a>
  ...
  <div class="hero" >
    ...
    <div class="first_row row w-100 container-fluid mt-5 justify-content-md-center ">
          ...
          $f = "select * from `bloggy_favorite` where `user_email` = '$email'";
          $fr = mysqli_query($con,$f);
          while($rowf = $fr->fetch_assoc()){
              $blog_id = $rowf["blog_id"];

            $b = "SELECT * FROM `bloggy_blog` where `blog_id` = '$blog_id'";
